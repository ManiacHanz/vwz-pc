<template>
  <div>
    <div class="alert">
      ...
      <div class="char">
        <p>温馨提示</p>
        <p>菜单编辑完成后需点击“保存并发布”，然后可通过“右上角--查看效果”访问微信网页。</p>
      </div>
    </div>
    <div class="body">
...
<script>
import mobilePanel from '../../../components/menuSet/mobilePanel.vue'
import setUpForm from '../../../components/menuSet/setUpForm'
export default {
  data () {
    return {
